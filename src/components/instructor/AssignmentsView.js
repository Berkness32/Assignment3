...
import {GRADEBOOOK_URL} from '../../Constants';
...
const AssignmentsView = (props) => {
    ...
    const fetchAssignments = async () => {
      ...
      try {
        const response = await fetch(`${GRADEBOOOK_URL}/sections/${secNo}/assignments`);
        if (response.ok) {
    ...
    const add = (assignment) => {
        ...
        fetch (`${GRADEBOOOK_URL}/assignments`, 
        {
          method: 'POST',
          headers: {
    ...
    const doDelete = (e) => {
        ...
        fetch (`${GRADEBOOOK_URL}/assignments/${id}`, 
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
