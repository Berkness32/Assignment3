...
function SectionsView(props) {
  ...
  const saveSection = async (section) => {
    try {
      const response = await fetchWithJWTHeader(`${SERVER_URL}/sections`, {
        method: "PUT",
        headers: {
  ...
  return (
    <div>
      ...
      <br />
      <button id="search" type="submit" onClick={fetchSections}>
        Search for Sections
      </button>
      <br />
      <br />
        ...
        <tbody>
          {sections.map((s) => (
            <tr key={s.secNo}>
              ...
              <td>{s.times}</td>
              <td>
                <AdminSectionUpdate section={s} save={saveSection} />
              </td>
              <td>
